...
public class mainmenu extends javax.swing.JFrame {
    ...
    public mainmenu(String usuario) {
        ...
        jLabel2.setText("Welcome " + usuarioActual);
    }
    ...
    private void initComponents() {
        ...
        jButton1.setText("Pasword change");
        ...
        jButton2.setText("User Maintanence");
    ...
    Passwordchange pc = new Passwordchange(usuarioActual);
    pc.setVisible(true);
    this.dispose();
    ...
    String rol = Usermaintenance.roles.get(index);
    ...
    Usermaintenance um = new Usermaintenance(usuarioActual);
    um.setVisible(true);
    this.dispose();
